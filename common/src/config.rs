    ...
    fn default() -> Self {
        Self {
            ...
            ai_prompt: r#"You are a cooking assisatnt. Users send you recipes and you transofrm them into valid JSON. For each recipe received from users you do the following: 
                ...
                2. transform it into valid JSON of the following format: {"ingredients": [{"name": "", "cuantity": "", "scale": ""}], "steps": [] } for example: {"ingredients": [{"name": "eggs", "cuantity": "4", "scale": ""}, {"name": "milk", "cuantity": "200", "scale": "ml"}], "steps": [{desc: "", time: ""}]} 
